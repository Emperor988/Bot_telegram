...
class Methods(Auth):
    ...
    def get_calendar_id(self, level, room):
        ...
        if level == '13':
            if '1' in room: return ROOMS_13['LEVEL13_ROOM1']
            if '2' in room: return ROOMS_13['LEVEL13_ROOM2']
            if '3' in room: return ROOMS_13['LEVEL13_ROOM3']
            if '4' in room: return ROOMS_13['LEVEL13_ROOM4']
            if '5' in room: return ROOMS_13['LEVEL13_ROOM5']
            if '6' or 'Вече' in room: return ROOMS_13['LEVEL13_VECE']
